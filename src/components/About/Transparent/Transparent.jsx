...
const Transparent = () => {
  return (
    <div className="transparent_container">
      <h3 className="transparentTitle transparent bold title kind mb-0">
      ...
      <div className=" section3 transparent-wrap showdiv">
        <p className="description">
          SOMETIMES WORK IS CHEF'S KISS, SOMETIMES WE BURN THE TOAST. STRENGTH
          STARTS WITH TRUTH.
        </p>
